...
if __name__ == "__main__":
    ...
    # as the table size is small spark may pick up Broadcast join automatically. So to stop that
    spark.conf.set("spark.sql.autoBroadcastJoinThreshold", -1)  # SortMerge join without shuffle.
